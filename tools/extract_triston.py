...
def main():
    ...
    # Escala UNIFORME (nada de por-tile: eso desalineaba edificios y deformaba props).
    # HERESY es nativo 64px/tile; extraemos a 1.0 y el mapa usa tileW=128 (ver convert_maps)
    # para que el diamante (64px) coincida con el pasto (64px) y quede como los otros mapas.
