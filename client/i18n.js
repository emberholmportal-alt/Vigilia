...
const DICT = {
  ...
  ok: { es: 'Entendido', en: 'Got it' },
  kicked_msg: { es: 'Tu cuenta entró desde otro lugar.', en: 'Your account signed in elsewhere.' },
  ...
  hof_open: { es: 'Salón de la Fama', en: 'Hall of Fame' },
  hof_title: { es: 'Salón de la Fama', en: 'Hall of Fame' },
  hof_sub: { es: 'Los más grandes de Velgrim. El mundo compite.', en: 'The greatest of Velgrim. The world competes.' },
  hof_tab_level: { es: 'Nivel', en: 'Level' },
  hof_tab_bosses: { es: 'Jefes', en: 'Bosses' },
  hof_tab_deepest: { es: 'Profundidad', en: 'Depth' },
  hof_bosses_u: { es: 'jefes', en: 'bosses' },
  hof_empty: { es: 'Todavía nadie dejó su marca.', en: 'No one has left their mark yet.' },
  char_guild: { es: 'Gremio', en: 'Guild' },
  char_guild_top: { es: 'Ranking de gremios', en: 'Guild ranking' },
  guildrank_title: { es: 'Ranking de gremios', en: 'Guild Ranking' },
  guildrank_sub: { es: 'Los gremios más poderosos del mundo. Solo lectura.', en: 'The most powerful guilds in the world. Read-only.' },
  guildrank_empty: { es: 'Todavía no hay gremios. Fundá el primero en la Casa de Gremios.', en: 'No guilds yet. Found the first one at the Guild Hall.' },
  ...
  start_msg: { es: 'Velgrim ya vive on-chain. Holdeá $VEL para cruzar el portal y sumate a la comunidad.', en: 'Velgrim is live on-chain. Hold $VEL to cross the portal and join the community.' },
  coin_link: { es: '$VEL en pump.fun', en: '$VEL on pump.fun' },
  twitter_link: { es: 'Seguinos en X', en: 'Follow on X' },
  ...
  mission_mine: { es: 'Extraé {n} de mastite', en: 'Mine {n} mastite' },
  ...
  mission_offering: { es: 'Dejá {n} oro de ofrenda en el Obelisco', en: 'Leave {n} gold as an offering at the Obelisk' },
  mission_in: { es: 'en {zone}', en: 'in {zone}' },
  mission_for: { es: 'para {npc}', en: 'for {npc}' },
  offer_prompt: { es: 'La piedra pide una ofrenda de {n} oro.', en: 'The stone asks for an offering of {n} gold.' },
  offer_give: { es: 'Ofrendar {n}', en: 'Offer {n}' },
  ...
  // Trade P2P
  trade_sent: { es: 'Le propusiste un intercambio a {name}', en: 'You proposed a trade to {name}' },
  trade_req_msg: { es: '{name} quiere comerciar', en: '{name} wants to trade' },
  trade_accept: { es: 'Aceptar', en: 'Accept' },
  trade_decline: { es: 'Rechazar', en: 'Decline' },
  trade_too_far: { es: 'Está muy lejos para comerciar', en: 'Too far away to trade' },
  trade_done: { es: '¡Intercambio completado!', en: 'Trade complete!' },
  trade_cancelled: { es: 'Intercambio cancelado', en: 'Trade cancelled' },
  trade_cancelled_r: { es: 'Intercambio cancelado: {r}', en: 'Trade cancelled: {r}' },
  trade_title: { es: 'Intercambio con {name}', en: 'Trade with {name}' },
  trade_your_offer: { es: 'Tu oferta', en: 'Your offer' },
  trade_their_offer: { es: 'Su oferta', en: 'Their offer' },
  trade_your_bag: { es: 'Tu bolsa', en: 'Your bag' },
  trade_your_inv: { es: 'Tu inventario', en: 'Your inventory' },
  trade_tap_to_offer: { es: 'tocá para ofrecer', en: 'tap to offer' },
  trade_bag_empty: { es: 'No tenés ítems sueltos para ofrecer. Desequipá algo primero.', en: 'No loose items to offer. Unequip something first.' },
  trade_howto: { es: 'Tocá ítems de tu bolsa para sumarlos a tu oferta y escribí cuánto oro das. Cuando estés listo, Confirmar: el intercambio se hace cuando los dos confirman.', en: 'Tap items in your bag to add them to your offer and type how much gold you give. When ready, Confirm: the trade happens once both confirm.' },
  trade_tap_to_remove: { es: 'tocá para sacar', en: 'tap to remove' },
  trade_offer_empty: { es: '(nada — agregá abajo)', en: '(nothing — add below)' },
  trade_gold: { es: 'Oro', en: 'Gold' },
  trade_confirm: { es: 'Confirmar', en: 'Confirm' },
  trade_confirmed: { es: 'Confirmado ✓', en: 'Confirmed ✓' },
  trade_waiting_them: { es: 'Esperando al otro…', en: 'Waiting for them…' },
  ...
  pm_combat: { es: 'Combate', en: 'Combat' },
  pm_skills: { es: 'Oficios', en: 'Trades' },
  pm_feats: { es: 'Hazañas', en: 'Feats' },
  feat_bosses: { es: 'Jefes derrotados', en: 'Bosses slain' },
  feat_deepest: { es: 'Zona más profunda', en: 'Deepest zone' },
  feat_boss_earned: { es: '¡Jefe derrotado! Hazaña {n}/{total}', en: 'Boss defeated! Feat {n}/{total}' },
  pm_res: { es: 'Resistencias', en: 'Resists' },
  pm_loading: { es: 'Cargando…', en: 'Loading…' },
  pm_noinfo: { es: 'Sin información de combate.', en: 'No combat info.' },
  ...
  stash_title: { es: 'Tu alijo', en: 'Your stash' },
  stash_sub: { es: 'Guardá acá lo que no querés cargar. Sólo vos lo ves.', en: "Stash what you don't want to carry. Only you see it." },
  stash_here: { es: 'En el alijo', en: 'In the stash' },
  stash_your_bag: { es: 'Tu bolsa', en: 'Your bag' },
  stash_your_inv: { es: 'Tu inventario', en: 'Your inventory' },
  stash_empty: { es: 'El alijo está vacío', en: 'The stash is empty' },
  stash_full: { es: 'El alijo está lleno', en: 'The stash is full' },
  stash_fail: { es: 'No se pudo', en: "Couldn't do that" },
  stash_label: { es: 'Tu alijo', en: 'Your stash' },
  stash_hint_deposit: { es: 'Tocá un ítem de tu bolsa para guardarlo', en: 'Tap a bag item to stash it' },
  stash_hint_withdraw: { es: 'Tocá un ítem del alijo para retirarlo', en: 'Tap a stash item to take it' },
  stash_gold_vault: { es: 'Oro en el alijo', en: 'Gold in the stash' },
  stash_gold_in: { es: 'Depositar', en: 'Deposit' },
  stash_gold_out: { es: 'Retirar', en: 'Withdraw' },
  stash_gold_wallet: { es: 'Llevás', en: 'You carry' },
  stash_belt_cta: { es: 'tocá para pasar a la bolsa', en: 'tap to move to bag' },
  market_title: { es: 'Mercado', en: 'Market' },
  market_tab_browse: { es: 'Comprar', en: 'Buy' },
  market_tab_mine: { es: 'Mis ventas', en: 'My listings' },
  market_tab_sell: { es: 'Vender', en: 'Sell' },
  market_price: { es: 'Precio', en: 'Price' },
  market_seller: { es: 'Vendedor', en: 'Seller' },
  market_buy: { es: 'Comprar', en: 'Buy' },
  market_cancel: { es: 'Retirar', en: 'Cancel' },
  market_publish: { es: 'Publicar', en: 'List' },
  market_your_bag: { es: 'Elegí un ítem de tu bolsa y ponele precio', en: 'Pick an item from your bag and set a price' },
  market_listed: { es: 'Publicado en el mercado', en: 'Listed on the market' },
  market_bought: { es: '¡Comprado!', en: 'Bought!' },
  market_cancelled: { es: 'Publicación retirada', en: 'Listing withdrawn' },
  market_fail: { es: 'No se pudo', en: "Couldn't do that" },
  market_empty: { es: 'No hay publicaciones', en: 'No listings' },
  market_mine_empty: { es: 'No tenés publicaciones activas', en: 'You have no active listings' },
  market_commission: { es: 'Comisión 5% al vender · máx 5 · 48hs', en: '5% fee on sale · max 5 · 48h' },
  market_offline: { es: 'El mercado necesita conexión', en: 'The market needs a connection' },
  // marketplace oro↔$VEL (order book P2P, pago on-chain)
  gm_open: { es: 'Cambiar oro por ${sym}', en: 'Trade gold for ${sym}' },
  gm_title: { es: 'Oro ⇄ ${sym}', en: 'Gold ⇄ ${sym}' },
  gm_sub: { es: 'Comprá oro pagando ${sym} · pago en tu wallet', en: 'Buy gold by paying ${sym} · paid from your wallet' },
  gm_tab_buy: { es: 'Comprar oro', en: 'Buy gold' },
  gm_tab_mine: { es: 'Mis órdenes', en: 'My orders' },
  gm_tab_sell: { es: 'Vender oro', en: 'Sell gold' },
  gm_buy: { es: 'Comprar', en: 'Buy' },
  gm_empty: { es: 'No hay oro a la venta', en: 'No gold for sale' },
  gm_mine_empty: { es: 'No tenés órdenes activas', en: 'You have no active orders' },
  gm_locked: { es: 'compra en curso', en: 'purchase in progress' },
  gm_sell_hint: { es: 'Publicás oro (queda en garantía) y pedís ${sym} a cambio. Mínimo {min} de oro.', en: 'List gold (held in escrow) and ask for ${sym} in return. Minimum {min} gold.' },
  gm_gold_amount: { es: 'Oro a vender', en: 'Gold to sell' },
  gm_ask_price: { es: 'Precio en ${sym}', en: 'Price in ${sym}' },
  gm_you_receive: { es: 'Recibís ~{n} ${sym} (95%)', en: 'You receive ~{n} ${sym} (95%)' },
  gm_publish: { es: 'Publicar orden', en: 'List order' },
  gm_not_enough_gold: { es: 'No tenés tanto oro', en: "You don't have that much gold" },
  gm_get_vel: { es: '¿No tenés ${sym}? Conseguí acá', en: "No ${sym}? Get some here" },
  gm_listed: { es: 'Orden publicada', en: 'Order listed' },
  gm_cancelled: { es: 'Orden cancelada', en: 'Order cancelled' },
  gm_bought: { es: '¡Oro comprado!', en: 'Gold bought!' },
  gm_taken: { es: 'Alguien la está comprando, probá otra', en: 'Someone is buying it, try another' },
  gm_fail: { es: 'No se pudo', en: "Couldn't do that" },
  gm_closed: { es: 'El mercado de tokens todavía no está abierto', en: "The token market isn't open yet" },
  gm_pay_cancel: { es: 'Pago cancelado', en: 'Payment cancelled' },
  gm_verify_fail: { es: 'No pudimos verificar el pago. Si te descontaron el token, guardá la firma y reintentá.', en: "Couldn't verify the payment. If the token left your wallet, keep the signature and retry." },
  gm_pay_lock: { es: 'Reservando la orden…', en: 'Reserving the order…' },
  gm_pay_sign: { es: 'Confirmá el pago en tu wallet', en: 'Confirm the payment in your wallet' },
  gm_pay_verify: { es: 'Verificando el pago on-chain…', en: 'Verifying the payment on-chain…' },
  gm_pay_hint: { es: 'Se abre tu wallet para firmar la transferencia de ${sym}.', en: 'Your wallet opens to sign the ${sym} transfer.' },
  ...
  forge_hint: { es: 'Mejorá el equipo con mastite de las minas.', en: 'Upgrade gear with mastite from the mines.' },
  forge_upgrade: { es: 'Mejorar', en: 'Upgrade' },
  forge_maxed: { es: 'Al máximo', en: 'Maxed' },
  forge_cost: { es: '{c} de mastite · {g} oro', en: '{c} mastite · {g} gold' },
  forge_max: { es: 'Esta pieza ya está al máximo', en: 'This piece is already maxed out' },
  forge_need_crystals: { es: 'Te falta mastite ({n})', en: 'You lack mastite ({n})' },
  ...
  grave_title: { es: 'Tu tumba', en: 'Your grave' },
  grave_sub: { es: 'Lo que dejaste al caer', en: 'What you left when you fell' },
  grave_armor: { es: 'Armadura', en: 'Armor' },
  grave_bag: { es: 'Bolsa', en: 'Bag' },
  grave_take_all: { es: 'Retirar todo', en: 'Take all' },
  grave_recovering: { es: 'Retirando…', en: 'Retrieving…' },
  ...
  skilld_excavacion: { es: 'Picar vetas de mastite en cuevas y minas.', en: 'Mine mastite veins in caves and mines.' },
  ...
  skilld_forja: { es: 'Forjar y mejorar equipo con mastite.', en: 'Forge and upgrade gear with mastite.' },
  ...
  tower_sign: { es: 'Descubrís algo bajo la Torre.', en: 'You uncover something beneath the Tower.' },
  ...
  guild_title: { es: 'Casa de Gremios', en: 'Guild Hall' },
  guild_need_online: { es: 'Los gremios necesitan conexión al mundo', en: 'Guilds need a connection to the world' },
  guild_offline_msg: { es: 'Conectate al mundo compartido para fundar o unirte a un gremio.', en: 'Connect to the shared world to found or join a guild.' },
  guild_tab_mine: { es: 'Mi gremio', en: 'My guild' },
  guild_tab_ranking: { es: 'Ranking', en: 'Ranking' },
  guild_none_title: { es: 'No pertenecés a ningún gremio', en: 'You are not in a guild' },
  guild_none_sub: { es: 'Fundá el tuyo por 500 de oro, o unite a uno del ranking.', en: 'Found your own for 500 gold, or join one from the ranking.' },
  guild_found_head: { es: 'Fundar un gremio', en: 'Found a guild' },
  guild_name_ph: { es: 'Nombre del gremio', en: 'Guild name' },
  guild_tag_ph: { es: 'Sigla (3)', en: 'Tag (3)' },
  guild_color: { es: 'Estandarte', en: 'Banner' },
  guild_found_btn: { es: 'Fundar — 500 oro', en: 'Found — 500 gold' },
  guild_founded: { es: 'Fundaste el gremio [{tag}]', en: 'You founded guild [{tag}]' },
  guild_joined: { es: 'Te uniste a [{tag}]', en: 'You joined [{tag}]' },
  guild_left: { es: 'Dejaste el gremio', en: 'You left the guild' },
  guild_bad_amount: { es: 'Monto inválido', en: 'Invalid amount' },
  guild_donated: { es: 'Donaste {n} de oro al gremio', en: 'You donated {n} gold to the guild' },
  guild_leveled: { es: '¡El gremio subió al nivel {n}!', en: 'Guild reached level {n}!' },
  guild_level_n: { es: 'Nivel {n}', en: 'Level {n}' },
  ...
  guild_power_hint: { es: 'El Poder suma cinco cosas, todas sin tope: la suma de niveles de los miembros, su promedio de nivel, la cantidad de miembros, el nivel del gremio y el oro donado al pozo. El promedio premia la calidad del roster, no sólo el tamaño. Todo server-autoritativo.', en: 'Power adds five uncapped things: the sum of member levels, their average level, the member count, the guild level, and the gold donated to the pool. The average rewards roster quality, not just size. All server-authoritative.' },
  guild_pw_levels: { es: 'Σ niveles {n}', en: 'Σ levels {n}' },
  guild_pw_avg: { es: 'prom {n}', en: 'avg {n}' },
  guild_pw_donated: { es: '{n} donado', en: '{n} donated' },
  guild_next_level: { es: 'Faltan {n} de oro para el nivel {l}', en: '{n} gold to level {l}' },
  guild_maxed: { es: 'Nivel máximo', en: 'Max level' },
  guild_donate_ph: { es: 'Oro a donar', en: 'Gold to donate' },
  guild_donate_btn: { es: 'Donar', en: 'Donate' },
  guild_leave_btn: { es: 'Dejar el gremio', en: 'Leave guild' },
  guild_leave_confirm: { es: '¿Seguro que querés dejar el gremio?', en: 'Leave the guild for sure?' },
  guild_roster: { es: 'Miembros', en: 'Roster' },
  guild_perks_head: { es: 'Ventajas por nivel', en: 'Level perks' },
  guild_perk1: { es: '+5% oro de botín', en: '+5% loot gold' },
  guild_perk2: { es: '+4 defensa a todos', en: '+4 defense for all' },
  guild_perk3: { es: '+5% de XP', en: '+5% XP' },
  guild_perk4: { es: 'Depósito del Gremio', en: 'Guild Deposit' },
  guild_perk5: { es: 'Estandarte visible en ciudad', en: 'Banner shown in town' },
  guild_perk6: { es: '+10% oro de botín', en: '+10% loot gold' },
  guild_perk7: { es: 'Recompensa de contrato ×1.5', en: 'Contract reward ×1.5' },
  guild_perk8: { es: '+10% de XP', en: '+10% XP' },
  guild_perk9: { es: '+8 defensa a todos', en: '+8 defense for all' },
  guild_perk10: { es: 'Recompensa de contrato ×2', en: 'Contract reward ×2' },
  guild_private: { es: 'Privado', en: 'Private' },
  guild_public: { es: 'Ingreso abierto', en: 'Open joining' },
  guild_make_private: { es: 'Hacer privado', en: 'Make private' },
  guild_make_public: { es: 'Abrir ingreso', en: 'Open joining' },
  guild_private_hint: { es: 'Gremio privado: sólo por invitación', en: 'Private guild: invite only' },
  guild_now_private: { es: 'Gremio privado: ahora sólo se entra por invitación', en: 'Guild set to private: invite only now' },
  guild_now_public: { es: 'Ingreso abierto: cualquiera puede unirse desde el ranking', en: 'Open joining: anyone can join from the ranking' },
  guild_founder: { es: 'Fundador', en: 'Founder' },
  guild_officer: { es: 'Oficial', en: 'Officer' },
  guild_member: { es: 'Miembro', en: 'Member' },
  guild_promote: { es: 'Ascender a oficial', en: 'Promote to officer' },
  guild_demote: { es: 'Bajar a miembro', en: 'Demote to member' },
  guild_transfer: { es: 'Transferir liderazgo', en: 'Transfer leadership' },
  guild_kick: { es: 'Expulsar', en: 'Kick' },
  guild_kick_confirm: { es: '¿Expulsar a {name} del gremio?', en: 'Kick {name} from the guild?' },
  guild_transfer_confirm: { es: '¿Transferir el liderazgo a {name}? Vas a pasar a oficial.', en: 'Transfer leadership to {name}? You will become an officer.' },
  guild_kicked: { es: 'Expulsaste a {name}', en: 'Kicked {name}' },
  guild_promoted: { es: 'Miembro ascendido a oficial', en: 'Member promoted to officer' },
  guild_demoted: { es: 'Oficial bajado a miembro', en: 'Officer demoted to member' },
  guild_transferred: { es: 'Liderazgo transferido a {name}', en: 'Leadership transferred to {name}' },
  guild_invite_sent: { es: 'Invitaste a {name} al gremio', en: 'Invited {name} to the guild' },
  ...
  // contrato semanal
  guild_contract_head: { es: 'Contrato semanal', en: 'Weekly contract' },
  guild_contract_undead: { es: 'Purgar {n} no-muertos', en: 'Purge {n} undead' },
  ...
  guild_dep_vault_gold: { es: 'Oro del depósito', en: 'Vault gold' },
  guild_dep_amount: { es: 'Oro', en: 'Gold' },
  guild_dep_in: { es: 'Depositar', en: 'Deposit' },
  guild_dep_out: { es: 'Retirar', en: 'Withdraw' },
  guild_dep_items: { es: 'Ítems del depósito', en: 'Vault items' },
  guild_dep_empty: { es: 'El depósito está vacío.', en: 'The vault is empty.' },
  guild_dep_put_item: { es: 'Guardar un ítem del inventario', en: 'Store an item from your bag' },
  ...
  gate_retry: { es: 'Ya la compré — reintentar', en: 'Already bought — retry' },
  gate_close: { es: 'Cerrar', en: 'Close' },
