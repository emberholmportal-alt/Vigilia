...
const DICT = {
  ...
  guild_power_hint: { es: 'El Poder suma cuatro cosas, todas sin tope: la suma de niveles de los miembros, la cantidad de miembros, el nivel del gremio y el oro donado al pozo. Todo server-autoritativo, así que donar y crecer siempre sube el ranking.', en: 'Power adds four uncapped things: the sum of member levels, the member count, the guild level, and the gold donated to the pool. All server-authoritative, so donating and growing always raises the ranking.' },
