  ...
  es: [
    ...
    },
    {
      ...
      body: [
        ...
        'El ranking ordena por el Poder del gremio, que suma cuatro cosas sin tope: los niveles de todos los miembros, la cantidad de miembros, el nivel del gremio y el oro donado al pozo. Crecer y donar siempre suben el ranking.',
      ],
  ...
  en: [
    ...
    },
    {
      ...
      body: [
        ...
        'The ranking is ordered by the guild Power, which adds four uncapped things: the levels of all members, the member count, the guild level, and the gold donated to the pool. Growing and donating always raise the ranking.',
      ],
