  ...
  es: [
    ...
    },
    {
      ...
      body: [
        ...
        'El ranking ordena por el Poder del gremio, que mezcla la suma y el promedio de nivel de sus miembros, el nivel del gremio, el oro donado al pozo y el oro de todos. Gana el más fuerte, no el más numeroso, y donar suma siempre (aun pasado el nivel máximo).',
      ],
  ...
  en: [
    ...
    },
    {
      ...
      body: [
        ...
        'The ranking is ordered by the guild Power, which blends the sum and average of member levels, the guild level, gold donated to the pool, and everyone’s gold. The strongest guild wins, not the biggest, and donating always helps (even past the level cap).',
      ],
