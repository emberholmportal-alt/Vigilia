...
const TRISTON = [
  ...
  { sprite: 'peasant_woman1', name: 'Udana la Vidente', name_en: 'Udana the Seer', portrait: 'female01.png', x: 58, y: 50, dir: 7,
    dialog: [
      ...
      { req: ['q3_init', 'q3_ice', 'q3_fire', 'q3_wind'], not: ['q3_finish'],
        lines: ['Traés los tres nombres. Pero no son míos para pronunciar.',
                'Llevalos a los Tres Guardianes, en la orilla del río. Decíselos a ellos, cara a piedra. Sólo así los sellos ceden.'],
        lines_en: ['You carry the three names. But they are not mine to speak.',
                   'Take them to the Three Guardians, on the riverbank. Say them to their faces, face to stone. Only so will the seals give way.'] },
  ...
  { sprite: 'statue_guardian_fire', name: 'Guardián de Fuego', name_en: 'Guardian of Fire', landmark: true, guardian: true, x: 18, y: 44, dir: 0, scale: 2.4,
  ...
  { sprite: 'statue_guardian_wind', name: 'Guardián del Viento', name_en: 'Guardian of Wind', landmark: true, guardian: true, x: 20, y: 46, dir: 0, scale: 2.4,
  ...
  { sprite: 'statue_guardian_ice', name: 'Guardián de Hielo', name_en: 'Guardian of Ice', landmark: true, guardian: true, x: 22, y: 48, dir: 0, scale: 2.4,
  ...
  // El viejo Garrick vio la Caída. Además da y cierra la quest "El Diario del Vigilante": tuvo un
  // amigo Vigilante, Aldwin, que bajó a buscar la verdad y no volvió, dejando su diario en pedazos.
  { sprite: 'peasant_man2', name: 'el viejo Garrick', name_en: 'Old Garrick', portrait: 'male18.png', x: 48, y: 48, dir: 4,
    dialog: [
      { req: ['d_finish'],
        lines: ['El diario de Aldwin está completo. Al fin sé cómo terminó. Descansá, viejo amigo.',
                'Cuidá tu nombre allá afuera, pibe. Es lo último que te queda.'],
        lines_en: ["Aldwin's journal is whole. At last I know how it ended. Rest, old friend.",
                   'Guard your name out there, boy. It is the last thing you have left.'] },
      { req: ['d_init', 'd_p1', 'd_p2', 'd_p3'], not: ['d_finish'], set: 'd_finish',
        lines: ['Los tres fragmentos... dejámelos ver. (Garrick lee en silencio, y algo se le rompe en la cara.)',
                'Aldwin sabía lo que venía. Lo escribió para que alguien lo supiera. No se sellaron: se escondieron.',
                'Gracias, Vigilante. Tomá esto; es poco al lado de lo que trajiste.'],
        lines_en: ['The three fragments... let me see them. (Garrick reads in silence, and something breaks in his face.)',
                   'Aldwin knew what was coming. He wrote it so someone would know. They did not seal themselves: they hid.',
                   'Thank you, Watcher. Take this; it is little beside what you brought.'] },
      { req: ['d_init'], not: ['d_finish'],
        lines: ['¿Encontraste algo del diario? Aldwin bajó por las cloacas, después la cripta, y su última guardia fue en el Fuerte Amir.',
                'Traeme lo que halles. Necesito saber qué vio.'],
        lines_en: ['Did you find any of the journal? Aldwin went down through the sewers, then the crypt, and his last watch was at Fort Amir.',
                   'Bring me what you find. I need to know what he saw.'] },
      { not: ['d_init'], set: 'd_init',
        lines: ['Yo vi las torres de Empyrea encendidas, pibe. Y vi cómo se apagaron, una por una.',
                'Tuve un amigo, un Vigilante como vos. Aldwin. Bajó a buscar la verdad de la Caída y no volvió.',
                'Dejó un diario, en pedazos, por donde anduvo. Encontralo. Necesito saber qué encontró él.'],
        lines_en: ['I saw the towers of Empyrea lit, boy. And I saw them go out, one by one.',
                   'I had a friend, a Watcher like you. Aldwin. He went down to find the truth of the Fall and never came back.',
                   'He left a journal, in pieces, wherever he walked. Find it. I need to know what he found.'] },
    ] },
...
const BLACK_OAK_CITY = [
  ...
  // El Centinela Aldric guarda la esquina viva de Black Oak City. Da y cierra la quest "Bajo la
  // Torre": sospecha que los Tres no se sellaron sino que bajaron, y te manda a la Torre del Mago
  // y al Inframundo que se abrió debajo. Conserva su voz de guardia cansada.
  { sprite: 'knight', name: 'Centinela Aldric', name_en: 'Sentinel Aldric', portrait: 'male07.png', x: 41, y: 11, dir: 7,
    dialog: [
      { req: ['t_finish'],
        lines: ['Así que la escalera nunca terminaba. Y ellos bajaron por ella, con todo lo que sabían.',
                'Vas a volver ahí abajo algún día. Todos volvemos. Andá con filo, Vigilante.'],
        lines_en: ['So the stair never ended. And they went down it, with everything they knew.',
                   "You'll go back down there one day. We all do. Go with a blade, Watcher."] },
      { req: ['t_init', 't_p1', 't_p2'], not: ['t_finish'], set: 't_finish',
        lines: ['Lo viste, entonces. La escalera que sigue, las marcas frescas en el Inframundo.',
                'No se sellaron. Bajaron, y siguen bajando. Que los dioses nos amparen. Tomá esto por tu coraje.'],
        lines_en: ['You saw it, then. The stair that goes on, the fresh marks in the Underworld.',
                   'They did not seal themselves. They went down, and they are going still. Gods keep us. Take this for your courage.'] },
      { req: ['t_init'], not: ['t_finish'],
        lines: ['¿Bajaste a la Torre? Al fondo de las avenidas está la entrada. Después la escalera sigue, hasta el Inframundo.',
                'Traeme lo que veas. Necesito saber si tengo razón.'],
        lines_en: ['Did you go down to the Tower? The entrance is at the end of the avenues. Then the stair keeps going, into the Underworld.',
                   'Bring me what you see. I need to know if I am right.'] },
      { not: ['t_init'], set: 't_init',
        lines: ['No queda muro que valga acá. Sólo esta esquina, y sólo porque la peleamos cada noche.',
                'La Torre del Mago sigue en pie al fondo. Los Tres estudiaron ahí antes de "sellarse".',
                'No me creo lo del sello. Creo que bajaron. Andá a la Torre, seguí la escalera, y decime qué hay abajo.'],
        lines_en: ['No wall worth the name holds here. Just this corner, and only because we fight for it every night.',
                   "The Wizard's Tower still stands at the far end. The Three studied there before they \"sealed\" themselves.",
                   "I don't buy the seal. I think they went down. Go to the Tower, follow the stair, and tell me what's below."] },
    ] },
