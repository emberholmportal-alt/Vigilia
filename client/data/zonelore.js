// Lore por zona: una línea atmosférica que aparece la PRIMERA vez que pisás un realm (canal
// 'mundo'). Teje la historia en el momento, sin cajas de diálogo. Bilingüe ES/EN. Keyed por mapa;
// las zonas sin entrada no muestran nada. Se dispara una sola vez (usa las flags de descubierto).
export const ZONE_LORE = {
  ...
  salted_field: {
    es: 'Nada crece en el Campo Salado desde que enterraron acá a los que no descansan.',
    en: 'Nothing grows in the Salted Field since they buried here those who do not rest.',
  },
  goblin_cave: {
    es: 'Los duendes no cavaron esta cueva. Se escondieron en ella, huyendo de lo que hay más abajo.',
    en: 'The goblins did not dig this cave. They hid in it, fleeing what lies further down.',
  },
  family_crypt: {
    es: 'Alguien selló esta cripta desde adentro. Nadie preguntó por qué.',
    en: 'Someone sealed this crypt from the inside. No one asked why.',
  },
  abandoned_mines: {
  ...
  goblin_camp: {
    ...
    en: 'A goblin camp on the surface. Not even they want to be underground anymore.',
  },
  st_maria_1: {
    es: 'Entre el hielo de Santa María duerme un nombre. Caminá sobre él y lo oirás resonar.',
    en: 'Among the ice of St. Maria a name sleeps. Walk upon it and you will hear it echo.',
  },
  perdition_mines: {
    es: 'Perdición no empieza acá; acá recién se nota. En el fuego de estas minas hay un nombre sellado.',
    en: 'Perdition does not begin here; here it just starts to show. In the fire of these mines a name lies sealed.',
  },
  stormrock_pass: {
    es: 'El viento del Paso Roca-Tormenta arrastra un nombre entre las piedras. No todos los que lo oyen vuelven.',
    en: 'The wind of Stormrock Pass drags a name among the stones. Not all who hear it return.',
  },
  iron_labyrinth_f1: {
    es: 'El corazón de hierro del mundo. Algo antiguo respira acá abajo. No hace falta que lo despiertes.',
    en: 'The iron heart of the world. Something ancient breathes down here. You need not wake it.',
  },
}
