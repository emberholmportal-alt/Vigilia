  ...
  return (
    <div className="gframe-backdrop">
      <div className="gframe trade-frame" onClick={(e) => e.stopPropagation()}>
        ...
        {/* Sólo la BOLSA: son los ítems ofrecibles. Para ofrecer armadura o cinturón, desequipalos
            antes en el inventario (van a la bolsa). Así el panel coincide con las instrucciones. */}
        <div className="trade-bag">
          <h4>{t('stash_your_bag')} <em className="trade-bag-cta">({t('trade_tap_to_offer')})</em></h4>
